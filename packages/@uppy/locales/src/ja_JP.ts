...
ja_JP.strings = {
  ...
  // additionalRestrictionsFailed: '%{count}件の追加制限が満たされていません',
  addMore: 'さらに追加',
  addMoreFiles: 'ファイルを追加',
  // aggregateExceedsSize: '選択したファイルサイズは%{size}ですが、最大許容サイズは%{sizeAllowed}です',
  // allFilesFromFolderNamed: '%{name}フォルダ内のすべてのファイル',
  allowAccessDescription:
    'カメラやビデオの機能を使用するには、カメラへのアクセスを許可してください。',
  allowAccessTitle: 'カメラへのアクセスを許可してください',
  // allowAudioAccessDescription: '音声を録音するには、このサイトへのマイクアクセスを許可してください。',
  ...
  // companionUnauthorizeHint: '%{provider}アカウントの認証解除は%{url}で行ってください',
  complete: '完了しました',
  ...
  // generateImage: '画像を生成',
  // generateImagePlaceholder: '松の木が湖面に映る山の湖に沈む穏やかな夕日',
  // generating1: 'AIが考え中...',
  ...
  // inferiorSize: 'このファイルは許可サイズ%{size}より小さいです',
  ...
  // },
  myDevice: 'マイデバイス',
  // noAudioDescription: '音声を録音するにはマイクまたは他の音声入力デバイスを接続してください',
  // noAudioTitle: 'マイクが利用できません',
  // noCameraDescription: '写真やビデオを撮影するにはカメラデバイスを接続してください',
  // noCameraTitle: 'カメラが利用できません',
  // noDuplicates: "重複ファイル「%{fileName}」は追加できません（すでに存在します）",
  ...
  // pluginNameGoogleDrive: 'Googleドライブ',
  // pluginNameGoogleDrivePicker: 'Googleドライブ',
  // pluginNameGooglePhotosPicker: 'Googleフォト',
  ...
  // pluginNameZoom: 'Zoom',
  // pluginWebdavInputLabel: 'ファイル用WebDAV URL（例: ownCloudやNextcloud）',
  ...
  // recording: '録音中',
  // recordingLength: '録音時間 %{recording_length}',
  // recordingStoppedMaxSize: 'ファイルサイズが上限に近づいたため録音を停止しました',
  // recordVideoBtn: 'ビデオ録画',
  // recoveredAllFiles: 'すべてのファイルを復元しました。アップロードを再開できます。',
  // recoveredXFiles: {
  //   '0': '1つのファイルを完全に復元できませんでした。再選択してアップロードを再開してください。',
